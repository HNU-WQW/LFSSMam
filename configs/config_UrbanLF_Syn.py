...
# Dataset config
"""Dataset Path"""
C.dataset_name = 'UrbanLF_Syn'
C.dataset_path = osp.join(C.root_dir, 'datasets', 'UrbanLF_Syn')
C.rgb_root_folder = osp.join(C.dataset_path, 'RGB')
C.rgb_format ='.png'       #111
...
C.is_test = False                                         #111
C.num_train_imgs = 172                                        #111
C.num_eval_imgs = 28                                        #111
...
# C.lf_image_names = ['5_1.png', '5_2.png', '5_3.png', '5_4.png', '5_6.png', '5_7.png', '5_8.png', '5_9.png']

# C.lf_image_names = ['1_5.png',  '2_5.png', '3_5.png', '4_5.png', '5_1.png', '5_2.png', '5_3.png', '5_4.png', '5_6.png', '5_7.png', '5_8.png',
#                     '5_9.png', '6_5.png',  '7_5.png', '8_5.png', '9_5.png']

# C.lf_image_names = ['1_1.png', '1_5.png', '2_2.png', '2_5.png', '3_3.png', '3_5.png', '4_4.png',
#                     '4_5.png', '5_1.png', '5_2.png', '5_3.png', '5_4.png', '5_6.png', '5_7.png', '5_8.png',
#                     '5_9.png', '6_5.png', '6_6.png', '7_5.png', '7_7.png', '8_5.png', '8_8.png', '9_5.png', '9_9.png']
...
C.backbone = 'LFSSMam_base' # LFSSMam_tiny /LFSSMam_small /LFSSMam_base
...
C.log_dir = osp.abspath('log_final/log_UrbanLF_Syn/' + 'log_' + C.dataset_name + '_' + C.backbone + '_' + 'lfcromb_lfconmb_cvssdecoder')
