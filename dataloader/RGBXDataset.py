...
class RGBXDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.preprocess is not None:
            rgb, gt, x, lf_images = self.preprocess(rgb, gt, x, lf_images)
        ...
        output_dict = dict(data=rgb, label=gt, modal_x=x, lf_images = lf_images, fn=str(item_name), n=len(self._file_names))
