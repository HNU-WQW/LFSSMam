...
def random_mirror(rgb, gt, modal_x, lf_images):
    ...
    return rgb, gt, modal_x, lf_images


def random_scale(rgb, gt, modal_x, lf_images, scales):
    ...
    return rgb, gt, modal_x, lf_images, scale
...
class TrainPre(object):
    ...
    def __call__(self, rgb, gt, modal_x, lf_images):
        rgb, gt, modal_x, lf_images = random_mirror(rgb, gt, modal_x, lf_images)
        if self.config.train_scale_array is not None:
            rgb, gt, modal_x, lf_images, scale = random_scale(rgb, gt, modal_x, lf_images, self.config.train_scale_array)
        ...
        return p_rgb, p_gt, p_modal_x, p_lf_images
